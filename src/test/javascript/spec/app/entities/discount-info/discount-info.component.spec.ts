...
import { DiscountInfoComponent } from 'app/entities/discount-info/discount-info.component';
...
describe('Component Tests', () => {
  describe('DiscountInfo Management Component', () => {
    let comp: DiscountInfoComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DiscountInfoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.discountInfos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
