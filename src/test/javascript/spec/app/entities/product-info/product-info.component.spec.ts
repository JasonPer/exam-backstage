...
import { ProductInfoComponent } from 'app/entities/product-info/product-info.component';
...
describe('Component Tests', () => {
  describe('ProductInfo Management Component', () => {
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ProductInfoComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.productInfos[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
